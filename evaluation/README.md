...
The catwalk code exists [here](https://github.com/anonymous/catwalk/tree/olmo-eval).
...
* Share the google sheet with `anonymous@anonymous.iam.gserviceaccount.com`.
* Create API json key and download from the Google Cloud Console.
* Add a beaker secret:
...
1. Add the new set under our current ppl data at /net/nfs.cirrascale/anonymous/eval_data.
...
1. See examples [here](https://github.com/anonymous/catwalk/tree/olmo-eval/catwalk/tasks).
2. Add newly created tasks to [TASKS_LM](https://github.com/anonymous/catwalk/blob/olmo-eval/catwalk/tasks/tasks_lm.py)
 or [TASKS](https://github.com/anonymous/catwalk/blob/olmo-eval/catwalk/tasks/__init__.py).