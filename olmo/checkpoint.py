...
class LocalShardedCheckpointer(Checkpointer):
    ...
    def _prepare_fsdp_model(self, fsdp_model: FSDP) -> None:
        ...
        # TODO: I'm not sure if this is necessary, but this is what PyTorch does before saving/loading
    ...
    def restore_checkpoint(
        ...
        *,
        ...
        if load_optimizer_state:
            ...
            # HACK/TODO: When we use adaptive clipping we track the 'grad_norm_exp_avg' for every param
